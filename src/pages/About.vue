<script setup>  
  ...
  const handleScroll = (evt) => {
    ...
    scrollY  <  second.value.offsetTop ? (scrollY + window.innerHeight - second.value.offsetTop) / 100  : 1
  ...
  <div class="aboutWrapper">
    ...
    <div class="member-group" ref="second">
      ...
      <div class="member-innder-wrapper">
        <div class="member" :style="{'background':`${member.member}`}"  v-for="(member,index) in memberList " :key="index">
          <div class="member-cover" :style="{'background':`${member.member_hover}`}"></div>
        </div>
      </div>
